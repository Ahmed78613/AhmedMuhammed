					...
					<div className={styles.bottomDiv}>
						<div className={` ${styles.bottomItem} ${styles.internship}`}>
							...
							<p>
								...
								WordPress. Designed, created and delivered a website alongside
								my team for a finance based business.
							</p>
						</div>
						<div className={styles.bottomItem}>
							<h2>Self Development</h2>
							<p>
								Personal Development as a Front-End Developer.
								Learning/Developing my skills and experience in frontend
								development, UI/UX design, ReactJS, JavaScript CSS/Sass and
								HTML.
							</p>
						</div>
					</div>
