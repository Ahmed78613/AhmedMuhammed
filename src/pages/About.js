		...
		<main className={styles.about}>
			...
			<div className={styles.details}>
				...
				<p>
					...
					individually, despite any obstacles that I may face. I am an organised
					individual who looks forward to learning new skills and growing as a
					person. I get along well with others and do not hesitate to ask any
					questions about something I don't understand. My career ambition has
					always been to become a web developer, as this is what I enjoy doing
					most. From requirement gathering, and design to the development stage.
				</p>
				<br />
				...
				<p>
					...
					vision to life. From gathering the clients' requirements to
					translating them into a dynamic and unique website with the help of my
